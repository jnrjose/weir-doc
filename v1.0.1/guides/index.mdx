...
<CardGroup cols={2}>
  ...
  <Card title="Platform Management" icon="server" href="/guides/platform-management">
  ...
  <Card title="Admin Operations" icon="shield" href="/guides/admin-operations">
    Create administrative tools for system management and monitoring.
  </Card>
  <Card title="Console API Integration" icon="desktop" href="/guides/console-apis">
...
<AccordionGroup>
  <Accordion title="Team Collaboration Tools" icon="users" defaultOpen={true}>
    ...
    **Start with**: [Team Management Guide](/guides/team-management)
  </Accordion>
  ...
  <Accordion title="Platform Administration" icon="server">
    ...
    **Start with**: [Platform Management Guide](/guides/platform-management)
  </Accordion>
  ...
  <Accordion title="User Administration" icon="user">
    ...
    **Start with**: [User Management Guide](/guides/user-management)
  </Accordion>
  ...
  <Accordion title="System Administration" icon="shield">
    ...
    **Start with**: [Admin Operations Guide](/guides/admin-operations)
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Best Practices" icon="star" href="/resources/concepts">
