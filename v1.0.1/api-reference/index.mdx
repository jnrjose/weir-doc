...
<CardGroup cols={3}>
  <Card title="External APIs" icon="globe" href="/api-reference/external-apis">
    Public-facing APIs for third-party integrations and external applications.
  </Card>
  <Card title="Console APIs" icon="desktop" href="/api-reference/console-apis">
    Organization management APIs for internal operations and team collaboration.
  </Card>
  <Card title="Admin APIs" icon="shield" href="/api-reference/admin-apis">
...
<CardGroup cols={2}>
  ...
  <Card title="Error Reference" icon="exclamation-triangle" href="/resources/error-codes">
