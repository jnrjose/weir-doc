...
<CardGroup cols={2}>
  ...
  <Card title="First API Call" icon="play" href="/getting-started/first-steps">
    Make your first successful API call and understand the response format.
  </Card>
  <Card title="API Categories" icon="sitemap" href="/resources/concepts">
...
<AccordionGroup>
  <Accordion title="I'm building a third-party integration" icon="globe" defaultOpen={true}>
    **Start with**: [External APIs Quick Start](/getting-started/quickstart#external-api-example)
  ...
  <Accordion title="I'm building internal management tools" icon="desktop">
    **Start with**: [Console APIs Quick Start](/getting-started/quickstart#console-api-example)
  ...
  <Accordion title="I'm a system administrator" icon="shield">
    **Start with**: [Admin APIs Documentation](/api-reference/admin-apis)
