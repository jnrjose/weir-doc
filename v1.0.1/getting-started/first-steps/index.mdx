...
<CardGroup cols={2}>
  ...
  <Card title="Try Integration Guides" icon="puzzle-piece" href="/guides">
    Follow detailed guides for building specific types of integrations
  </Card>
  <Card title="Check Code Examples" icon="code" href="/examples">
    Browse ready-to-use code examples in multiple languages
  </Card>
  <Card title="Learn Best Practices" icon="star" href="/resources/concepts">
